    ...
    stages {
        stage('Build Test Deploy') {
			...
			sh 'podman run -it --rm localhost/$IMAGE_NAME otter --version'
                        ...
                        sh 'podman run -it --rm localhost/$IMAGE_NAME python -c "import numpy; import pandas; import altair; import matplotlib; import sklearn; sklearn.show_versions(); import xgboost; import torch; import scipy; import seaborn; import cvxpy; import statsmodels"'
