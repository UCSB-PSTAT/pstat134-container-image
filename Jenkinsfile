    ...
    stages {
        stage('Build Test Deploy') {
			...
			sh 'podman run -it --rm localhost/$IMAGE_NAME otter --version'
                        ...
                        sh 'podman run -it --rm localhost/$IMAGE_NAME python -c "import faiss-cpu'
                        ...
                        sh 'podman run -it --rm localhost/$IMAGE_NAME python -c "import lightfm"'
                        ...
                        sh 'podman run -it --rm localhost/$IMAGE_NAME python -c "import opencv-python"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME python -c "import pandas"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME python -c "import pillow"'
                        ...
                        sh 'podman run -it --rm localhost/$IMAGE_NAME python -c "import python-dateutil"'
                        ...
                        sh 'podman run -it --rm localhost/$IMAGE_NAME python -c "import sentence-transformers"'
                        ...
                        sh 'podman run -it --rm localhost/$IMAGE_NAME python -c "import surprise"'
                        ...
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"caret\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"coop\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"curl\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"data.table\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"dplyr\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"EBImage\")"'
                        ...
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"httr2\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"imager\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"janitor\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"jsonlite\")"'
                        ...
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"magick\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"OpenImageR\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"plotly\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"polite\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"purrr\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"quanteda\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"ranger\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"readr\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"recommenderlab\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"recosystem\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"reticulate\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"robotstxt\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"ROCR\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"RSelenium\")"'
                        ...
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"spacyr\")"'
                        ...
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"tensorflow\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"text\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"text2vec\")"'
                        ...
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"tm\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"tokenizers\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"torch\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"wordcloud\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"xgboost\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"xml2\")"'
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"yardstick\")"'
